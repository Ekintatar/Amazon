...
class TestDeleteProductFromWishlist(unittest.TestCase):
    """Test case is:
    ...
    def setUp(self):
        self.driver = webdriver.Chrome("/home/izzet/Desktop/Selenium/Amazon/Drivers/chromedriver")
        ...
        print("TestCheckFbmessengerCampaignDeletion")
